...
contract StargateBaseTest is Deployer, TestHelper {
    ...
    function setUp() public {
        ...
        transferOwnershipUniV3Dex(OWNER);
    ...
    function testInitIsCorrect() public {
        verifyStargateYieldModule(OWNER, address(goblinBank), address(uniV3));
    }
    ...
    function deployStargateYieldModule(address goblinBank, address dex) internal override {
        ERC1967Proxy proxy = new ERC1967Proxy(address(stargateYieldModuleImpl), "");
